...
<div id="layout-wrapper">
    ...
    <div class="app-menu navbar-menu">
        ...
        <div class="navbar-brand-box">
            ...
            <a href="index.html" class="logo logo-dark">
                    <span class="logo-sm">
                        <img src="{{ asset('AFfood.png') }}" alt="" height="60">
                    </span>
                <span class="logo-lg">
                        <img src="{{ asset('AFfood.png') }}" alt="" height="60">
                    </span>
                ...
                <ul class="navbar-nav" id="navbar-nav">
                    ...
                    <li class="nav-item">
                        <a class="nav-link menu-link" href="{{ route('product.index') }}">
                            <i class="mdi mdi-tag"></i> <span data-key="t-dashboards">Products</span> <span class="badge badge-pill bg-danger" data-key="t-hot">New</span>
                        </a>
                    </li>

                    <li class="nav-item">
                        <a class="nav-link menu-link" href="{{ route('category.index') }}">
                            <i class="mdi mdi-view-grid-plus-outline"></i> <span data-key="t-dashboards">Categories</span>
                        </a>
                    </li>
