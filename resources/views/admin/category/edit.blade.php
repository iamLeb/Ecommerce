                                            ...
                                            <div class="card-body">
                                                ...
                                                <div class="row">
                                                    <div class="col-md-6 text-start">
                                                        <a href="{{ route('category.edit', $category->id) }}" class="btn btn-light"> <i class="mdi mdi-pen"></i> Edit</a>
                                                    </div>
                                                    <div class="col-md-6 text-end">
                                                        <a href="javascript:void(0);" class="btn btn-danger"><i class="mdi mdi-trash-can"></i> Delete</a>
                                                    </div>
                                                </div>
                                            </div>
                                        </div><!-- end card -->
