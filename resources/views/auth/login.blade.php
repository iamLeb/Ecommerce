...
<head>
    ...
    <meta content="iamleblib" name="author" />
    <!-- App favicon -->
                            ...
                            <div class="p-2 mt-4">
                                ...
                                <form action="{{ route('login') }}" method="POST">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input placeholder="Enter e-mail address" type="email" class="form-control @error('email') is-invalid @enderror" name="email" value="{{ old('email') }}" required autocomplete="email" autofocus>
                                        @error('email')
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <div class="position-relative auth-pass-inputgroup mb-3">
                                            ...
                                            @enderror
                                            <button class="btn btn-link position-absolute end-0 top-0 text-decoration-none text-muted shadow-none password-addon" type="submit" id="password-addon">
...
<!-- Mirrored from themesbrand.com/velzon/html/material/auth-signin-basic.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Sep 2023 20:50:19 GMT -->
</html>
